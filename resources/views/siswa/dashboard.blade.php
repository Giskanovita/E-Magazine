...
<div class="page-title">
  <div class="container d-lg-flex justify-content-between align-items-center">
    <h1 class="mb-2 mb-lg-0">Dashboard Siswa</h1>
    <nav class="breadcrumbs">
      <ol>
        <li><a href="/">Home</a></li>
        <li class="current">Dashboard Siswa</li>
      </ol>
    </nav>
  </div>
</div>
...
<div class="container">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h2>Selamat Datang{{ Auth::check() ? ', ' . Auth::user()->nama : ' di Dashboard Siswa' }}</h2>
    <a href="{{ route('siswa.artikel.index') }}" class="btn btn-primary">
  ...
  <div class="row">
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('siswa.artikel.edit', $artikel->id_artikel) }}" class="btn btn-sm btn-outline-primary">
    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-body">
          <div class="d-grid gap-2">
            <a href="{{ route('siswa.artikel.create') }}" class="btn btn-success">
      ...
      <div class="card mt-3">
        <div class="card-header">
          <h5>Tips untuk Siswa</h5>
        </div>
        <div class="card-body">
          <ul class="list-unstyled">
            <li class="mb-2"><i class="bi bi-check-circle text-success"></i> Tulis dengan bahasa yang baik</li>
            <li class="mb-2"><i class="bi bi-check-circle text-success"></i> Sertakan foto yang menarik</li>
            <li class="mb-2"><i class="bi bi-check-circle text-success"></i> Periksa ejaan sebelum publish</li>
            <li class="mb-2"><i class="bi bi-check-circle text-success"></i> Bagikan pengalaman positif</li>
          </ul>
        </div>
      </div>
    </div>
